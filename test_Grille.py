...
def test_liste_vide():
    ...
    assert grille.liste_vide() == [(0, 0), (1, 0), (2, 0), (3, 0),
                                   (0, 1), (1, 1), (2, 1), (3, 1),
                                   (0, 2), (1, 2), (2, 2), (3, 2),
                                   (0, 3), (1, 3), (2, 3), (3, 3)]
...
def test_liste_vide():
    ...
    # Teste la liste des cases vides après avoir ajouté une tuile
    assert grille.liste_vide() == [(0, 0), (2, 0), (3, 0), (0, 1), 
                                   (3, 1), (0, 2), (1, 2), (2, 2), 
                                   (3, 2), (0, 3), (1, 3), (2, 3), (3, 3)]
